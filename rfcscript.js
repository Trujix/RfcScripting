// ************************************************************************************
 /*
  * LINK DECRETO SECRETARIA DE ADMINISTRACIÓN TRIBUTARIA -> https://www.sat.gob.mx/cs/Satellite?blobcol=urldata&blobkey=id&blobtable=MungoBlobs&blobwhere=1579314729570&ssbinary=true
  ...
  * los Trabajadores; del Código Fiscal de la Federación; de la Ley del Impuesto sobre la Renta; de la
  * Ley del Impuesto al Valor Agregado; de la Ley Federal de los Trabajadores al Servicio del Estado,
  * Reglamentaria del Apartado B) del Artículo 123 Constitucional; de la Ley Reglamentaria de la
  * Fracción XIII Bis del Apartado B, del Artículo 123 de la Constitución Política de los Estados Unidos
  * Mexicanos, en materia de Subcontratación Laboral.
  * 
  *  ------------ SCRIPT EJECUTADO Y EVALUADO POR L.I.A. MANUEL TRUJILLO GÓMEZ ------------
 */
// ************************************************************************************

// :::::::::::::::::::::: LIBRERIA PARA GENERAR RFC ::::::::::::::::::::::
function generarRFC(ap_paterno, ap_materno, nombre, rfcnacim, sexo, estado, mostrarLogRFC = false) {
    var rfc = rfcnacim;
...
function generarEstadoAbrev(estado) {
    var abrev = "CM";
    for (var llave in estadosJSON) {
        if (estado.indexOf(estadosJSON[llave]) >= 0) {
            abrev = llave;
        }
    }
}
